 ...
 * @LastEditTime : 2026-03-18 00:40:19
...
#(
  ...
  (* mark_debug *)input  wire [DATA_BITS-1:0] uart_tx_fifo_din,
  (* mark_debug *)input  wire                 uart_tx_fifo_wr_en,
  (* mark_debug *)output wire                 uart_tx_fifo_full,
...
//++ 输入发送FIFO ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
(* mark_debug *)wire [DATA_BITS-1:0] uart_tx_fifo_dout;
(* mark_debug *)wire                 uart_tx_fifo_rd_en;
(* mark_debug *)wire                 uart_tx_fifo_empty;
syncFIFO #(
...
//++ 发送数据FIFO接口连接 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
(* mark_debug *)reg uart_tx_fifo_rd_en_tmp;
